    ...
    <div>
        ...
        <div className="mx-6 py-10 text-center md:text-left">
          ...
          ">
            ...
            <div className="">
              <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start ml-[8.5rem]">
                Menu
              </h6>
              <p className="mb-2 ">
                <a href="#!" className="text-gray-600 no-underline ">Trang chủ</a>
              </p>
              <p className="mb-2">
                <a href="#!" className="text-gray-600 no-underline">Sản phẩm</a>
              </p>
              <p className="mb-2">
                <a href="#!" className="text-gray-600 no-underline">Giới thiệu</a>
              </p>
              <p className=' mb-2'>
                <a href="#!" className="text-gray-600 no-underline">Tin tức</a>
              </p>
              <p className=' mb-2'>
                <a href="#!" className="text-gray-600 no-underline">Liên hệ</a>
              </p>
            </div>
            ...
            <p className="flex items-center justify-center md:justify-start mb-2 ">
              <a href="#!" className="text-gray-600 no-underline">Đăng ký</a>
            </p>
            <p className="mb-2 flex items-center justify-center md:justify-start">
              <a href="#!" className="text-gray-600 no-underline">Đăng nhập</a>
            </p>
            </div>
        ...
        <div className="flex justify-center items-center lg:justify-between p-6 border-t border-gray-300 ">
